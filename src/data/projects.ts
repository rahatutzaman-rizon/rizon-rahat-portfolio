...
export const projectsData: ProjectItem[] = [
  {
    id: "ai-rag-agent-suite",
    slug: "ai-rag-agent-suite",
    title: "Enterprise AI Agent & RAG Suite",
    subtitle: "Auto-Indexing RAG, Access-Control RAG, Multi-Agent Handoffs & Observability",
    shortDescription:
      "Production-grade enterprise AI agent suite featuring automated knowledge base re-indexing, RBAC access-control RAG, confidence scoring, fallback model chains, LangSmith-style tracing, and structured JSON extractions.",
    fullDescription: [
    ...
    domain: "Enterprise AI & Agentic RAG",
    category: "AI & Automation",
    featured: true,
    role: "AI Systems Engineer & Full Stack Architect",
    period: "2024 – Present",
    client: "Enterprise SaaS & AI Automation Clients",
    techStack: [
      "Next.js 16",
      "TypeScript",
      "LangChain",
    ...
    metrics: [
      { label: "Answer Confidence", value: "96.4%" },
      { label: "Retrieval Speed", value: "142ms" },
      { label: "Daily Hits", value: "18.4K" },
      { label: "JSON Extraction Accuracy", value: "98.9%" },
    ],
    links: {
      github: "https://github.com/rahatutzaman-rizon/",
    },
    gradient: "from-cyan-600/30 via-indigo-600/20 to-purple-500/10",
    accentColor: "#06b6d4",
  },
  {
    id: "fto-travels",
