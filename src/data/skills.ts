...
export const skillsData: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Enterprise SQL Tuning", level: "Advanced", featured: true },
  ...
  },
  {
    ...
    iconName: "Smartphone",
    description: "Cross-platform mobile engineering using React Native, Expo, mobile state management, and native API bridges.",
    skills: [
      { name: "React Native", level: "Advanced", featured: true },
      { name: "Expo CLI & Tooling", level: "Advanced", featured: true },
      { name: "Cross-Platform iOS & Android", level: "Advanced", featured: true },
      { name: "Mobile UI / Components", level: "Advanced", featured: true },
      { name: "Mobile Navigation & Routing", level: "Proficient", featured: true },
      { name: "Redux / Zustand Mobile State", level: "Proficient", featured: true },
      { name: "REST / GraphQL Mobile APIs", level: "Advanced", featured: false },
    ],
  },
  {
    id: "data-analytics",
    ...
    skills: [
      ...
      { name: "SQL Query Performance", level: "Advanced", featured: true },
  ...
  {
    id: "databases",
    category: "Databases & NoSQL Architecture",
    iconName: "Database",
    description: "NoSQL & relational database architecture, schema migrations, multi-tenant isolation, and performance tuning.",
    skills: [
      { name: "MongoDB (NoSQL)", level: "Advanced", featured: true },
      { name: "NoSQL & Document Modeling", level: "Advanced", featured: true },
      { name: "Data Migration & ETL", level: "Advanced", featured: true },
      { name: "MySQL & PostgreSQL", level: "Advanced", featured: true },
      { name: "Multi-Tenant DB Isolation", level: "Advanced", featured: true },
      { name: "Schema Transformation", level: "Proficient", featured: true },
      { name: "Redis Caching", level: "Proficient", featured: false },
      { name: "Query Performance Tuning", level: "Advanced", featured: true },
    ],
  },
  {
    id: "business-domains",
